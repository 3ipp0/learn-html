...
Завдання № 2:
Використовуючи теги які ми пройшли на занятті, або ж теги які ви вже знали до цього - оформити сторінку "Про себе".
(Підказка: можете додати відео чи музику яку слухаєте, опишіть що читаєте, де працюєте/навчаєтесь, що цікаво.
Головне - використайте побільше тегів, і бажано "в тему").
![biography](/screenshots/lesson_1/les_1_bio.png)
![media](/screenshots/lesson_1/les_1_media.jpg)
...
Технічне завдання має складатися з основних пунктів, та підпунктів.
Це має бути у вигляді вимог до програміста по функціоналу (як уявляєте так і формулюйте).
![lists](/screenshots/lesson_2/les_2_lists.png)
...
![tables](/screenshots/lesson_3/lesson_3_index_tables.png)
...
![tables_css](/screenshots/lesson_4/lesson_4_tables_css.png)
